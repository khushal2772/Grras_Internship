...
while i < len(sales_data):
    total_sales = 0
    j=0
    while j <len(sales_data):
        total_sales += sales_data[j][i]
        j+=1
    i+=1
    print(f"Total sales of 202{i} Restaurant is {total_sales}")
...
while i < len(sales_data):
    ...
    while j <len(sales_data):
        ...
        j+=1
    i+=1
    print(f"Average sales of 202{i} Restaurant is {total_sales/j}")
